...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-100 to-white py-16 px-6 lg:px-12">
      ...
      {!loading && !error && (
        products.length === 0 ? (
          <p className="text-center text-gray-600 mt-12">No products available.</p>
        ) : (
