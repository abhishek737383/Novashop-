...
export default function OrderPage() {
  ...
  const singleImg  = params.get("allImages") || "";
  const images     = imagesAll.length > 0 ? imagesAll : [singleImg];
  const initialIdx = parseInt(params.get("index") || "0", 10) || 0;
