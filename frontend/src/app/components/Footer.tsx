  ...
  return (
    <div className="bg-gray-50 pt-20 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto animate-slide-up"
      ...
      <footer
        className="relative z-10 mt-20 py-8 text-center text-sm text-gray-500 animate-slide-up"
