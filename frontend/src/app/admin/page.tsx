...
export default function AdminPage() {
  ...
  async function verifyKey(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
        ...
        {loadingP ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((p) => (
              ...
              >
                <div className="relative w-full h-56 cursor-pointer" onClick={() => setSelectedImage(p.imageUrls[0])}>
                  <Image
                    src={p.imageUrls[0]}
                    alt={p.name}
                    fill
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-6 border-b lg:border-b-0 lg:border-r">
                      <div className="relative w-full h-52 mb-4 cursor-pointer" onClick={() => setSelectedImage(o.image)}>
                        <Image
                          src={o.image}
                          alt={o.productName}
                          fill
                    ...
                    <div className="p-6 bg-gray-50 flex flex-col items-center justify-center">
                      {pay ? (
                        <>
                          <div className="relative w-32 h-32 mb-4 cursor-pointer" onClick={() => setSelectedImage(pay.screenshotUrl)}>
                            <Image
